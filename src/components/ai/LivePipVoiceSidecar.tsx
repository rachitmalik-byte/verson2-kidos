...
export const LivePipVoiceSidecar: React.FC = () => {
  ...
  return (
    <>
      {/* Floating Action Button for Pip (Cleanly placed in bottom-right corner) */}
      <div className="fixed bottom-20 md:bottom-6 right-4 sm:right-6 z-[99900] flex items-center">
        <motion.button
