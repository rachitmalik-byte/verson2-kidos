      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999999] flex items-center justify-center p-3 sm:p-4">
          ...
          <motion.div
            ...
            className="relative z-10 bg-white w-full max-w-lg rounded-3xl md:rounded-[36px] border-4 border-sky-400 shadow-2xl overflow-hidden flex flex-col h-[560px] max-h-[92vh]"
          >
            {/* Header */}
