      ...
      case 6:
        return (
          <div className="w-full max-w-4xl flex flex-col items-center">
            ...
            {/* Step 2: Microscopic Porosity Cross-Section with Side-by-Side SEM Micrographs */}
            {currentStepIndex === 2 && (
              <div className="w-full max-w-4xl bg-white p-6 md:p-8 rounded-3xl border-4 border-amber-400 shadow-xl text-center flex flex-col items-center">
                <span className="text-xs font-black uppercase tracking-wider text-amber-800 bg-amber-100 px-3 py-1 rounded-full mb-2">
                  100x SEM Micrograph Fiber Comparison
                </span>
                <h3 className="text-2xl font-black text-slate-900 mb-2">Why Cotton Breathes & Polyester Traps Sweat</h3>
                <p className="text-xs md:text-sm text-slate-600 font-bold mb-6 max-w-2xl">
                  Look inside the actual electron microscope images below to see the physical difference between plant pores and synthetic plastic rods!
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-6">
                  ...
                  <div className="p-4 bg-emerald-50 rounded-2xl border-2 border-emerald-300 text-center flex flex-col items-center">
                    <span className="font-black text-emerald-950 text-sm mb-2">🌿 Natural Cotton (100x Micrograph)</span>
                    <div className="w-full h-56 rounded-2xl overflow-hidden bg-slate-950 border-2 border-emerald-400 shadow-md mb-2">
                      <img src={cottonMicrograph100xImg} alt="Cotton Micrograph 100x" className="w-full h-full object-cover" />
                    </div>
                    <span className="text-xs font-bold text-emerald-900 leading-relaxed">
                      💡 <strong>Hollow Lumen Pores:</strong> Cotton fibers are hollow plant tubes with millions of micro-pores that wick liquid sweat away like tiny drinking straws!
                    </span>
                  </div>

                  {/* Polyester Solid Filament */}
                  <div className="p-4 bg-rose-50 rounded-2xl border-2 border-rose-300 text-center flex flex-col items-center">
                    <span className="font-black text-rose-950 text-sm mb-2">👕 Synthetic Polyester (100x Micrograph)</span>
                    <div className="w-full h-56 rounded-2xl overflow-hidden bg-slate-950 border-2 border-rose-400 shadow-md mb-2">
                      <img src={nylonMicrograph100xImg} alt="Synthetic Micrograph 100x" className="w-full h-full object-cover" />
                    </div>
                    <span className="text-xs font-bold text-rose-900 leading-relaxed">
                      ⚠️ <strong>Solid Plastic Cylinders:</strong> Synthetic fibers are smooth solid plastic rods with ZERO pores. Moisture cannot enter, trapping heat and sweat inside!
                    </span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="px-8 py-3.5 bg-gradient-to-r from-amber-400 to-orange-400 text-slate-950 font-black text-sm rounded-2xl cursor-pointer shadow-md active:scale-95 transition-all"
                >
                  Continue to Summer Outfit Challenge ➔
                </button>
              </div>
            )}
